...
class _EnrollStudentScreenState extends State<EnrollStudentScreen> {
            ...
            child: SingleChildScrollView(
              ...
              child:
                  (Provider.of<AuthService>(
                        context,
                      ).currentUser?.assignedClasses.isEmpty ??
                      true)
                  ? _buildNoClassesView()
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: Container(
              height: 2,
              color: _currentStep > 0 ? Colors.blue : Colors.grey.shade200,
            ),
          ),
          ...
          Expanded(
            child: Container(
              height: 2,
              color: _currentStep > 1 ? Colors.blue : Colors.grey.shade200,
            ),
          ),
  ...
  Widget _buildAcademicStep() {
    ...
    final List<String> sectionOptions = assigned.isNotEmpty
        ? assigned
              .where((e) => e['classId'] == _selectedClass)
              .map((e) => e['section']!)
              .toSet()
              .toList()
        : ['A', 'B', 'C'];
                ...
                onChanged: (v) {
                  setState(() {
                    ...
                    if (assigned.isNotEmpty) {
                      final availableSections = assigned
                          .where((e) => e['classId'] == v)
                          .toList();
  ...
  Widget _buildGuardianStep() {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 8),
        const Text(
          'Finalize the contact and login details.',
          style: TextStyle(color: AppColors.textSecondary, fontSize: 13),
        ),
        const SizedBox(height: 32),
        _buildInputField(
          ...
          Expanded(
            ...
            child: ElevatedButton(
              ...
              child: _isLoading
                  ...
                  : Text(
                      _currentStep == 2 ? 'Submit Student' : 'Next Step',
